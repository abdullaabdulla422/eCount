 ...
 */
public class PartReceiptListViewSwipeGesture implements View.OnTouchListener {
    Activity activity;
    ...
    public PartReceiptListViewSwipeGesture(ListView listView, TouchCallbacks Callbacks, Activity context){
    ...
    private void SetBackGroundforList() {
        ...
        mDownView_parent_txt1.setWidth(300);
        ...
        if(SwipeType==Double){
            ...
            mDownView_parent_txt2.setWidth(300);
