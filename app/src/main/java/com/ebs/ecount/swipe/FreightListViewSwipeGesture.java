...
public class
FreightListViewSwipeGesture implements OnTouchListener {
    Activity activity;
    ...
    public FreightListViewSwipeGesture(ListView listView, TouchCallbacks Callbacks, Activity context){
    ...
    private void GetResourcesValues() {
        ...
        HalfColor           =   singleColor;          //Red
        FullColor           =   activity.getResources().getString(R.string.str_orange);         //Orange
        HalfText            =   activity.getResources().getString(R.string.action_1);
    ...
    private void SetBackGroundforList() {
        ...
        mDownView_parent_txt1.setTypeface(mDownView_parent_txt1.getTypeface(), Typeface.BOLD);
         ...
         if(SwipeType==Double){
             ...
             RelativeLayout.LayoutParams lp2 =new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
