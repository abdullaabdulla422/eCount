...
/**
 * Created by cbetechubt-016 on 23/3/18.
 */

public class GetVarianceList extends SoapUtils {
    ...
    public static GetVarianceList parseQty(SoapObject soapObject) throws Exception{
        GetVarianceList qty = new GetVarianceList();
